...
export const LessonPlanScalarFieldEnumSchema = z.enum(['id','topic','unit','frame','ageGroup','superGoal','operativeGoals','priorKnowledge','lessonFlow','teachingAids','references','isPublished','createdAt','updatedAt','authorId']);
...
export const LessonPlanWhereInputSchema: z.ZodType<Prisma.LessonPlanWhereInput> = z.strictObject({
  ...
  priorKnowledge: z.union([ z.lazy(() => StringNullableFilterSchema), z.string() ]).optional().nullable(),
...
export const LessonPlanOrderByWithRelationInputSchema: z.ZodType<Prisma.LessonPlanOrderByWithRelationInput> = z.strictObject({
  ...
  priorKnowledge: z.union([ z.lazy(() => SortOrderSchema), z.lazy(() => SortOrderInputSchema) ]).optional(),
...
export const LessonPlanScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LessonPlanScalarWhereWithAggregatesInput> = z.strictObject({
  ...
  operativeGoals: z.lazy(() => StringNullableListFilterSchema).optional(),
  priorKnowledge: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema), z.string() ]).optional().nullable(),
