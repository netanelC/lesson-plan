...
export const SectionCard = ({ title, icon, theme, children, className }: SectionCardProps) => {
  return (
    <section className={clsx('space-y-4 rounded-lg p-6 shadow-sm border', THEME_STYLES[theme], className)}>
      <h3 className={clsx('text-lg font-bold flex items-center gap-2', TITLE_COLORS[theme])}>
